...
# Announcements are shown as a banner on the homepage between their start
# and expiration dates. "start_date" is optional (announcement is active
# immediately), "expiration_date" is required.
